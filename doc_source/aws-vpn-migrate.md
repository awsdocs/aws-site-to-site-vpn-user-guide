...
1. Add routes that point to your on\-premise network and choose the transit gateway as the target\. For the destination routes, enter more specific routes, for example, if your on\-premise network is `10.0.0.0/16`, create a route that points to `10.0.0.0/17` and another route that points to `10.0.128.0/17`\. Asymmetric traffic routing stops and all traffic is routed through the transit gateway\.
**Note**  
