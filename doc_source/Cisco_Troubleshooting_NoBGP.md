# Troubleshooting Cisco IOS customer gateway device without Border Gateway Protocol connectivity<a name="Cisco_Troubleshooting_NoBGP"></a>
...
First, check that you have the necessary firewall rules in place\. For more information, see [Configuring a firewall between the internet and your customer gateway device](your-cgw.md#FirewallRules)\.
