# Identity\-based policy examples for AWS Site\-to\-Site VPN<a name="security_iam_id-based-policy-examples"></a>

By default, users and roles don't have permission to create or modify Site\-to\-Site VPN resources\. They also can't perform tasks by using the AWS Management Console, AWS Command Line Interface \(AWS CLI\), or AWS API\. An IAM administrator must create IAM policies that grant users and roles permission to perform actions on the resources that they need\. The administrator must then attach those policies for users that require them\.
...
## Using the Site\-to\-Site VPN console<a name="security_iam_id-based-policy-examples-console"></a>
